...
//		Test.info("info");
	...
	public void beforeMethodMethod(@Optional String browserName, Method testMethod) throws IOException {
		ExtentTest logger = extent.startTest("browser");
	...
	public WebDriver setupDriver1(WebDriver driver2) throws IOException {
		...
		// FileReader("D:\\ecilipsestaples\\Ecilipse\\ui-test-robustautomation\\src\\main\\java\\Base\\global.properties");
		FileReader reader = new FileReader(System.getProperty("user.dir") + File.separator + "src/main/java/Base"
		...
		if (browserame.equalsIgnoreCase("chrome")) {
			...
			// capability.setCapability(MobileCapabilityType.DEVICE_NAME, "Redmi Note 10T
			// 5G");
			...
			// "com.eservicepro.tech.e_service_pro_technician");

			// capability.setCapability("appActivity",
			// "com.eservicepro.tech.e_service_pro_technician.MainActivity");

			// capability.setCapability("appPackage", "com.hss.android.viaetruck");

			// capability.setCapability("appActivity",
			// "com.hss.android.viaetruck.activity.SplashScreen");
